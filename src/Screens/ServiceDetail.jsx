    ...
    <>
      <div className="bg-[#D2D2DB] ">
        ...
        <div className="bg-[#D2D2DB] relative top-[700px]  h-auto py-20 w-screen overflow-hidden flex flex-col items-center justify-center ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8 items-center justify-center max-sm:mx-5  mx-16">
            <div className="bg-white drop-shadow-xl rounded-lg h-[480px] sm:h-[450px]   lg:h-[500px] xl:h-[500px]  w-[330px] text-center md:w-[400px] lg:w-[290px] xl:w-[400px]  grid grid-rows-2    items-center justify-evenly gap-2">
              ...
              <div className="flex  flex-col items-center justify-center ">
                <h2 className="text-black   maven-pro-bold">
                  Web Application Development
                </h2>

                <p className="text-black p-4 text-justify lg:text-sm    content-center maven-pro-regular">
            ...
            <div className="bg-white drop-shadow-xl rounded-lg h-[480px] sm:h-[450px]   lg:h-[500px] xl:h-[500px]  w-[330px] text-center md:w-[400px] lg:w-[290px] xl:w-[400px]  grid grid-rows-2   items-center justify-evenly gap-2">
              <div className="flex flex-col  items-center justify-center">
                <img
                  src={MAD}
                  alt="imageHere"
                  className="h-48 max-lg:h-3 drop-shadow-xl"
                />
              </div>
              <div className="flex flex-col items-center justify-center ">
                <h2 className="text-black  maven-pro-bold">
