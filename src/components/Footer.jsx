...
const Footer = () => {
  ...
  return (
    <>
      <div className="h-100 pt-28 bg-white px-12">
        <ATCarousel />
      </div>
      {/* ================= >>> Footer <<< ================ */}
      <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 items-center gap-6 justify-center py-10 overflow-hidden">
        ...
        <div className=" py-4 h-full md:border-l-4 border-dotted flex flex-col items-start justify-center mx-[10%] lg:px-20 md:px-15 sm:px-4 w-[100%]">
          <div
